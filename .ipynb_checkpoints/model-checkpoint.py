...
class QNetBN(nn.Module):
    ...
    def quantize(self, num_bits=8):
        self.qconv1 = QConvBNRelu(self.conv1, self.bn1, qi=True, qo=True, num_bits=num_bits)
        self.qmaxpool2d_1 = QMaxPooling2d(kernel_size=2, stride=2, padding=0, qi=True)
        self.qconv2 = QConvBNRelu(self.conv2, self.bn2, qi=True, qo=True, num_bits=num_bits)
        self.qmaxpool2d_2 = QMaxPooling2d(kernel_size=2, stride=2, padding=0, qi=True)
        self.qfc = QLinear(self.fc, qi=True, qo=True, num_bits=num_bits)
